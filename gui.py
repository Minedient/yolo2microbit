...
class Ui_MainDialog(object):
    def setupUi(self, MainDialog):
        ...
        self.gridLayoutWidget.setGeometry(QRect(0, 10, 391, 321))
        ...
        self.gridLayout.addWidget(self.runtimeLogger, 7, 0, 1, 5)
